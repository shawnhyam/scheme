...
any read_pair(FILE *in) {
    ...
    if (c == '.') { /* read improper list */
        ...
        return tag_pair(make_pair(car_obj, cdr_obj));
    }
    else { /* read list */
        ungetc(c, in);
...
#define BUFFER_MAX 1000
	...
	//assert(0);
      ...
      return tag_pair(make_pair(tag_symbol(make_symbol("quote")), 
				tag_pair(make_pair(read(in), empty_list))));
    }
    else {
